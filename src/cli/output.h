...
enum output_format {
	...
	OUTPUT_RAW_BIT_LEFT = 0 | OUTPUT_FLAG_BINARY,
	OUTPUT_RAW_BIT_RIGHT = 1 | OUTPUT_FLAG_BINARY,
	OUTPUT_RAW_BYTE = 2 | OUTPUT_FLAG_BINARY,
	...
	OUTPUT_FARBFELD = 6 | OUTPUT_FLAG_IMAGE,
};
...
#define OUTPUT_HAS_ALPHA(format) ((format) == OUTPUT_PNG || (format) == OUTPUT_TGA || (format) == OUTPUT_FARBFELD)
